...
// Käyttäjä-API 
export const registerUser = (data) => api.post("/register", data); // Rekisteröi uuden käyttäjän
export const loginUser = (data) => api.post("/login", data);       // Kirjaa käyttäjän sisään ja palauttaa tokenin
